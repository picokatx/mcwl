...
function descendSucceed(s, args) {
    printStream.success(s, args);
}
function descendFail(s, args) {
    printStream.failure(s, args);
}
function descendInfo(s, args) {
    printStream.info(s, args);
}
const descendCmd = new Command(locale.get("cmd_name_descend"), locale.get("cmd_description_descend"), [
    new CommandFormat([
