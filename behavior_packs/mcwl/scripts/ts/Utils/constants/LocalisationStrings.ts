export const Locale_EN_GB: Map<string, string> = new Map<string, string>([
...
export const LOCALE_ZH_HANS: Map<string,string> = new Map<string,string>(
    [
...
export class Locale {
    ...
    get(s: string): string {
        let ret:string = this.languageMap.get(s);
