...
function topSucceed(s, args) {
    printStream.success(s, args);
}
function topFail(s, args) {
    printStream.failure(s, args);
}
function topInfo(s, args) {
    printStream.info(s, args);
}
const topCmd = new Command(locale.get("cmd_name_top"), locale.get("cmd_description_top"), [
    new CommandFormat([])
